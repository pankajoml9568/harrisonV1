...
@include('includes.title', ['banner' => ($category_info)?$category_info->banner:'', 'title'=>($item)?$item->name:'Product'])
  ...
  <!-- start section -->
                                ...
                                <div class="swiper-container product-image-slider" data-slider-options='{ "spaceBetween": 10, "watchOverflow": true, "navigation": { "nextEl": ".slider-product-next", "prevEl": ".slider-product-prev" }, "thumbs": { "swiper": { "el": ".product-image-thumb", "slidesPerView": "auto", "spaceBetween": 15, "direction": "vertical", "navigation": { "nextEl": ".swiper-thumb-next", "prevEl": ".swiper-thumb-prev" } } } }' data-thumb-slider-md-direction="horizontal">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <a class="gallery-link" href="{{asset('assets/images/'.$item->photo)}}">
                                                <img class="w-100" src="{{asset('assets/images/'.$item->photo)}}" alt="">
                                            </a>
                                        </div>
                                        <!-- end slider item -->
                                        <!-- start slider item -->
                                        @foreach ($galleries as $key => $gallery)
                                            <div class="swiper-slide">
                                                <a class="gallery-link" href="{{asset('assets/images/'.$gallery->photo)}}">
                                                    <img class="w-100" src="{{asset('assets/images/'.$gallery->photo)}}" alt="">
                                                </a>
                                            </div>
                                        @endforeach
                                        <!-- end slider item -->
                    ...
                    <div class="w-40 md-w-100 product-summary padding-5-rem-left lg-padding-5-rem-left md-no-padding-left">
                        <div class="d-flex align-items-center margin-3-half-rem-tb md-margin-1-half-rem-tb">
                            ...
                            <input type="hidden" value="{{$setting->currency_direction}}" id="currency_direction">
                                ...
                                <span id="main_price" class="product-price main-price">{{PriceHelper::grandCurrencyPrice($item)}}</span>
                        ...
                        <div class="margin-4-rem-topmargin-4-rem-top">
                            ...
                            <div class="row align-items-end pb-4">
                                <div class="col-sm-12 d-flex">
                                    ...
                                    @if ($item->item_type != 'affiliate')
                                        @if ($item->is_stock())
                                        <button class="btn btn-dark-gray btn-medium m-0 a-t-c-mr" id="add_to_cart"><i class="icon-bag"></i><span>{{ __('Add to Cart') }}</span></button>
                                        <button class="btn btn-dark-gray btn-medium m-0" id="but_to_cart"><i class="icon-bag"></i><span>{{ __('Buy Now') }}</span></button>
                                        @else
                                            <button class="btn btn-dark-gray btn-medium m-0"><i class="icon-bag"></i><span>{{__('Out of stock')}}</span></button>
                                        @endif
                                    @else
                                    <a href="{{$item->affiliate_link}}" target="_blank" class="btn btn-dark-gray btn-medium m-0"><span><i class="icon-bag"></i>{{ __('Buy Now') }}</span></a>
                                    @endif
    ...
    <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 ">
                    <img src="{{ asset('assets/harrison/images/1097-details.jpg') }}" alt="">
                </div>
            </div>
    </div>
  <!-- Harrison theme End -->
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-image border-radius-6px">
                                ...
                                <a href="{{route('front.product',$item->slug)}}">
                                    <img class="default-image" src="{{asset('assets/images/'.$item->thumbnail)}}" alt=""/>
                                    <img class="hover-image" src="{{asset('assets/images/'.$item->thumbnail)}}" alt=""/>
                                </a>
                            ...
                            <div class="product-footer text-center gray-bg padding-10px-bottom">
                                <a href="{{route('front.product',$item->slug)}}"
                                    ...
                                    {{ strlen(strip_tags($item->name)) > 38 ? substr(strip_tags($item->name), 0, 38) : strip_tags($item->name) }}
                                </a>
