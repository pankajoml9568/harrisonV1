<ul class="nav">
    ...
    <li class="nav-item">
        ...
        <div class="collapse" id="leads">
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="{{ route('leads.list', ['type' => 'contact-us']) }}">
                      <span class="sub-item">{{ __('Contact') }}</span></a>
                </li>
                <li>
                    <a class="sub-link" href="{{ route('leads.list', ['type' => 'become-dealer']) }}">
                        <span class="sub-item">{{ __('Become a Dealer') }}</span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="{{ route('leads.list', ['type' => 'architect-designer']) }}">
                        <span class="sub-item">{{ __('Architect & Designer Connect') }}</span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="{{ route('leads.list', ['type' => 'become-associate']) }}">
                        <span class="sub-item">{{ __('Become a Associate') }}</span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="{{ route('leads.list', ['type' => 'career']) }}">
                        <span class="sub-item">{{ __('Career') }}</span>
                    </a>
                </li>
            </ul>
        </div>
