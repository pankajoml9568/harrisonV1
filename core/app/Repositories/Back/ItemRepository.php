...
class ItemRepository
{
    ...
    public function store($request)
    {
        ...
        if ($file = $request->file('photo')) {
            $images_name = 'harrison/items'.ImageHelper::ItemhandleUploadedImage($request->file('photo'),'assets/images/harrison/items');
    ...
    public function update($item,$request)
    {
        ...
        if ( $request->file('photo')) {
            ...
            $images_name = 'harrison/items'.ImageHelper::ItemhandleUpdatedUploadedImage($request->photo,'/assets/images/harrison/items',$item,'/assets/images/harrison/items/','photo');
            $input['photo'] = $images_name[0];
            $input['thumbnail'] = $images_name[1];
        }
    ...
    public function storeImageData($request,$item_id=null)
    {
        ...
        if ($galleries = $request->file('galleries')) {
            foreach($galleries as $key => $gallery){
                $storeData[$key] = [
                    'photo'=>  'harrison/items/'.ImageHelper::handleUploadedImage($gallery,'assets/images/harrison/items'),
