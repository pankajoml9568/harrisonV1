...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Harrison route start 

            Route::get('leads/{type}', 'Back\LeadsController@index')->name('leads.list');
            Route::get('lead/{type}/view/{id}', 'Back\LeadsController@show')->name('lead.show');
            Route::delete('lead/{type}/delete/{id}', 'Back\LeadsController@destroy')->name('lead.destroy');
        // End Harrison route start 
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        // Harrison route start 
            // Form submit
            Route::get('become-a-dealer', 'Front\FormController@becomeDealerForm')->name('form.become-a-dealer');
            Route::get('architect-and-designer-connect', 'Front\FormController@architectDesignerConnectForm')->name('form.architect-and-designer-connect');
            Route::get('become-a-associate', 'Front\FormController@becomeAssociateForm')->name('form.become-a-associate');
            Route::get('contact', 'Front\FormController@contactForm')->name('front.contact');
            Route::get('career', 'Front\FormController@careerForm')->name('form.career');

            Route::post('form/become-a-dealer/submit', 'Front\FormController@becomeDealer')->name('form.become-a-dealer.save');
            Route::post('form/architect-and-designer-connect/submit', 'Front\FormController@architectDesignerConnect')->name('form.architect-designer-connect.save');
            Route::post('form/become-a-associate/submit', 'Front\FormController@becomeAssociate')->name('form.become-a-associate.save');
            Route::post('contact/submit', 'Front\FormController@contactSave')->name('front.contact.submit');
            Route::post('career/submit', 'Front\FormController@careerSave')->name('form.career.submit');
            // for End

            Route::get('corporate-overview', 'Front\PagesController@corporateOverview')->name('corporateOverview');
            Route::get('mission-vision', 'Front\PagesController@missionVision')->name('missionVision');
            Route::get('our-client', 'Front\PagesController@ourClient')->name('ourClient');
            Route::get('milestones', 'Front\PagesController@milestones')->name('milestones');
            Route::get('awards', 'Front\PagesController@awards')->name('awards');
            Route::get('news-media', 'Front\PagesController@newsMedia')->name('newsMedia');
            Route::get('gallery', 'Front\PagesController@gallery')->name('gallery');
            Route::get('videos', 'Front\PagesController@videos')->name('videos');
