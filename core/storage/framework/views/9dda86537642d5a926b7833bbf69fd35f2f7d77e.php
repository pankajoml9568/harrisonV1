							...
							<div class="p-5">
								<form class="admin-form" action="<?php echo e(route('back.page.update',$page->id)); ?>"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img" src="<?php echo e(asset($page->banner)); ?>" alt="No Image Found">
										<br>
									...
									<div class="form-group">
										...
										<textarea name="html" id="html" class="form-control" rows="10"
											...
											required><?php echo e($page->html); ?></textarea>
									</div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/harrison/core/resources/views/back/page/edit.blade.php ENDPATH**/ ?>