						...
						<div class="col-lg-12">
								<form class="admin-form" action="<?php echo e(route('back.childcategory.update',$childcategory->id)); ?>" method="POST"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="<?php echo e($childcategory->banner ? asset('assets/images/'.$childcategory->banner) : asset('assets/images/placeholder.png')); ?>"
												alt="No Image Found">
										<!-- <br>
									...
									<div class="form-group">
										...
										><?php echo e($childcategory->description); ?></textarea>
									</div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/harrison/core/resources/views/back/childcategory/edit.blade.php ENDPATH**/ ?>