<ul class="nav">
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#leads">
            ...
            <p><?php echo e(__('Leads')); ?></p>
            <span class="caret"></span>
        </a>
        <div class="collapse" id="leads">
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('leads.list', ['type' => 'contact-us'])); ?>">
                      <span class="sub-item"><?php echo e(__('Contact')); ?></span></a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('leads.list', ['type' => 'become-dealer'])); ?>">
                        <span class="sub-item"><?php echo e(__('Become a Dealer')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('leads.list', ['type' => 'architect-designer'])); ?>">
                        <span class="sub-item"><?php echo e(__('Architect & Designer Connect')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('leads.list', ['type' => 'become-associate'])); ?>">
                        <span class="sub-item"><?php echo e(__('Become a Associate')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('leads.list', ['type' => 'career'])); ?>">
                        <span class="sub-item"><?php echo e(__('Career')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
...
<?php /**PATH /var/www/html/harrison/core/resources/views/master/inc/super.blade.php ENDPATH**/ ?>