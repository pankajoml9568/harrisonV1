        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-xl-6 col-lg-7 col-md-10 page-title-large text-center">
                ...
                <span class="d-block text-white opacity-6 alt-font margin-5px-bottom xs-line-height-20px"><a
                        href="<?php echo e(url('/')); ?>"><?php echo e(__('Home')); ?></a> // <?php echo e($page->title); ?> </span>
            </div>
        </div>
    </div>
</section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\harrison\core\resources\views/front/page.blade.php ENDPATH**/ ?>