...
<section class="parallax inner-banner" data-parallax-background-ratio="0.5"
    style="background-image: url('<?php echo e(asset('assets/harrison/images/page-title-bg-03.jpg')); ?>');">
    <div class="opacity-extra-medium bg-extra-dark-gray"></div>
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-xl-6 col-lg-7 col-md-10 page-title-large text-center">
                <h1 class="alt-font text-white font-weight-500 no-margin-bottom"><?php echo e(__('Our mission and Vission')); ?></h1>
                <span class="d-block text-white opacity-6 alt-font margin-5px-bottom xs-line-height-20px">
                    <a href="<?php echo e(url('/')); ?>"><?php echo e(__('Home')); ?></a> // <?php echo e(__('Our mission and Vission')); ?>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 offset-xl-1 align-self-end text-center text-xl-left">
                <img src="<?php echo e(asset('assets/harrison/images/who-we-are-image-1.png')); ?>" alt="" />
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 margin-70px-top lg-margin-30px-top md-margin-50px-bottom">
                <div class="w-70 border-radius-6px overflow-hidden position-relative">
                    <img src="<?php echo e(asset('assets/harrison/images/our-process-02.jpg')); ?>" alt="" />
...
<!-- end section -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/harrison/core/resources/views/front/pages/mission-vision.blade.php ENDPATH**/ ?>