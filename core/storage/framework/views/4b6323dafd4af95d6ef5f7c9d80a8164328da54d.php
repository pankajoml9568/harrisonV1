						...
						<div class="col-lg-12">
								<form class="admin-form" action="<?php echo e(route('back.category.update',$category->id)); ?>"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="<?php echo e($category->banner ? asset('assets/images/'.$category->banner) : asset('assets/images/placeholder.png')); ?>"
												alt="No Image Found">
                                        <!-- <br>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/harrison/core/resources/views/back/category/edit.blade.php ENDPATH**/ ?>