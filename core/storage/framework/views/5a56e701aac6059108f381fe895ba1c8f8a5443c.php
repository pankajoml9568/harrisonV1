            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-lg-5 offset-lg-1 col-md-10 wow animate__fadeIn home_ab_right_cont" data-wow-delay="0.4s">
                        ...
                        <a href="corporate-overview.php" class="btn btn-fancy btn-large btn-dark-gray margin-20px-top">Read More</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center">
                    <div
                        ...
                        <h5 class="alt-font font-weight-700 text-uppercase text-extra-dark-gray letter-spacing-minus-1px m-0">
                            Products catering to your varing needs </h5>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-lg-4 col-sm-8 text-center text-lg-left md-margin-5-rem-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        ...
                        <a href="find-architect.php" class="btn btn-fancy btn-large btn-dark-gray margin-20px-top">connect with an architect</a>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">2-Ball Bearing Butt Hinges</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Caninet Handle</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Door Closer</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    <!-- start fancy text box slider item -->
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Door Handle</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Furniture Lock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Handle Set</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Hydraulic Hinges</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Maindoor lock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Padlock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Tower Bolt</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                            ...
                            <div class="swiper-container black-move"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">4-Ball Bearing Butt Hinges</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Auto Close Concealed Hinges</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Center Shutter Lock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    <!-- start fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Door Handle Set</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Door Stopper</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">main door lock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Pad lock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Pro Soft Slide</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Screws</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">side shutter lock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
                                    ...
                                    <div class="swiper-slide text-center padding-15px-all">
                                        ...
                                        <div class="move-bottom-top margin-15px-top">
                                            <a href="javascript:void(0)" class="lock-btns">Soft Touch Lock</a>
                                        </div>
                                    </div>
                                    <!-- end fancy text box slider item -->
            ...
            <div class="container">
                ...
                <div class="row"> 
                    <div class="col-12 text-center">
                        <a href="blog-masonry.html" class="btn btn-link thin btn-extra-large text-extra-dark-gray margin-30px-top d-inline-block md-margin-40px-top sm-margin-20px-top">View all updates</a>
                    </div>
                </div>     
            </div>
        </section>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\projects\harrison\core\resources\views/front/themes/theme1.blade.php ENDPATH**/ ?>